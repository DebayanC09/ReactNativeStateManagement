...
import {SignUpState} from '../../store/reducers/signup/SignUpReducer';
...
const SignUpScreen = ({navigation}: SignUpScreenProps) => {
  const state: SignUpState = useAppSelector(
    rootState => rootState.signUpReducer,
  );
  ...
  useEffect(() => {
    if (state.status === ACTION_TYPES.SUCCESS) {
      storeUserData(state.userData as UserModel).then(_ => {
